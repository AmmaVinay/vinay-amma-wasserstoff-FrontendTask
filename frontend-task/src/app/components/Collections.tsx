    ...
    return (
        <div className="pl-12 pb-10">
            <div>
                ...
                >
                    <h1 className="font-bold w-[341px] h-[66px] left-[992px] text-3xl leading-tight mt-12 mb-8">
            ...
            >
                <p className="text-base w-[316px] h-[104px] text-[16px] leading-relaxed mb-4">
            ...
            <div className="flex justify-between">
                ...
                >
                    <button className="text-black w-[154px] font-extrabold text-center bg-[#FFCA5F] rounded-full py-3 px-4">
                        Join Waitlist
                    </button>
                </motion.div>
            </div>
